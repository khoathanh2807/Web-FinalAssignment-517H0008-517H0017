	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<a href="pccomponent.php"><img class="first-slide" src="images/ba.jpg" alt="First slide" width="1100px" height="500px"></a>

			</div>
			<div class="item">
				<a href="gaminggear.php"> <img class="second-slide " src="images/ba1.jpg" alt="Second slide" width="1100px" height="500px"></a>

			</div>
			<div class="item">
				<a href="console.php"><img class="third-slide " src="images/ba2.jpg" alt="Third slide" width="1100px" height="500px"></a>
			...
			<div class=" con-w3l agileinf">
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="single.php">Intel Core i9 9900K 3.6GHz - 5GHz | 8C - 16T</a></h6>
							</div>
							<div class="mid-2">
				...
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6>Intel Core i7 9700K 3.6GHz - 4.9GHz | 8C - 8T</h6>
							</div>
							<div class="mid-2">
