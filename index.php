...
<body>
    ...
    <!---->
    <div data-vide-bg="images/banner.png">
        <div class="container">
        ...
        <div class="container ">
            ...
            <div class="tab-head ">
                <nav class="nav-sidebar">
                    <ul class="nav tabs ">
                        <li class="active"><a href="#tab1" data-toggle="tab">CPU</a></li>
                        <li class=""><a href="#tab2" data-toggle="tab">GPU</a></li>
                        <li class=""><a href="#tab3" data-toggle="tab">Monitor</a></li>
                        <li class=""><a href="#tab4" data-toggle="tab">Console</a></li>
                    </ul>
                </nav>
                        ...
                        <div class=" con-w3l">
                            <div class="col-md-3 m-wthree">
                                <div class="col-m">
                                    ...
                                    <div class="mid-1">
                                        <div class="women">
                                            <h6><a href="single.php">Intel Core i9 9900K 3.6GHz - 5GHz | 8 Cores - 16 Threads</a></h6>
                                        </div>
                                        <div class="mid-2">
                            ...
                            <div class="col-md-3 m-wthree">
                                <div class="col-m">
                                    ...
                                    <div class="mid-1">
                                        ...
                                        <div class="add">
                                            <button class="btn btn-danger my-cart-btn my-cart-b" data-id="4" data-name="Intel Core i3 9300" data-summary="summary 4" data-price="3590000" data-quantity="1" data-image="images/of3.png">Add to Cart</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="content-mid">
        <div class="container">
            ...
            <div class="col-md-4 m-w3ls">
                <div class="col-md1 ">
                    <a href="pccomponent.php">
                        <img src="images/co1.jpg" class="img-responsive img" alt="">
                        <div class="big-sa">
                            <h6>New Collections</h6>
                            <h3>Computer <span>Component</span></h3>
                            <p>There are a variety of computer configurations for you to choose, let's build your most suitable PC setup.</p>
                        </div>
                    </a>
                </div>
            </div>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <a href="pccomponent.php"> <img class="first-slide" src="images/ba.jpg" alt="First slide"></a>

        </div>
        <div class="item">
            <a href="gaminggear.php"> <img class="second-slide" src="images/ba1.jpg" alt="Second slide"></a>

        </div>
        <div class="item">
            <a href="console.php"><img class="third-slide" src="images/ba2.jpg" alt="Third slide"></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <a href="pccomponent.php"><img class="first-slide" src="images/ba.jpg" alt="" width="1100px" height="500px"></a>
            </div>

            <div class="item">
                <a href="gaminggear.php"><img class="second-slide" src="images/ba1.jpg" alt="" width="1100px" height="500px"></a>
            </div>

            <div class="item">
                <a href="console.php"><img class="third-slide" src="images/ba2.jpg" alt="" width="1100px" height="500px"></a>
            </div>
        </div>
