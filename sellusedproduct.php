    ...
    <div class="product">
        <div class="container">
            ...
            <div class="main-agileits" style="width:60%;">
                <div class="form-w3agile" style="width:100%;">

                    <form action="add.php" method="post" enctype="multipart/form-data">

                        <h5><b>Product Name:</b></h5>
                        <input type="text" class="form-control form-group" name="productname">

                        <h5><b>Image:</b></h5>
                        <input type="file" class="form-control form-group" name="uploadfile">

                        <h5><b>Price (Unit: VND):</b></h5>
                        <input type="text" class="form-control form-group" name="price">

                        <h5><b>Discription:</b></h5>
                        <input type="text" style="height: 100px;" class="form-control form-group" name="description">
