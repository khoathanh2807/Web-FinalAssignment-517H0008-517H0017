...
<body>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="console.php"><i class="fa fa-angle-right" aria-hidden="true"></i>SONY Play Station 4<</a> </li> <li><a href="console.php"><i class="fa fa-angle-right" aria-hidden="true"></i>PS4 Controller</a></li>
	...
	<div class="login">
		<div class="main-agileits">
			<div class="form-w3agile form1">
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					<div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
						...
						<input type="text" name="username" class="form-control" value="<?php echo $username; ?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}" required="">
					...
					<div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
						...
						<input type="password" name="password" class="form-control" value="<?php echo $password; ?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
						<span class="help-block"><?php echo $password_err; ?></span>
						<div class="clearfix"></div>
					</div>
					<div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
						<i class="fa fa-lock" aria-hidden="true"> Confirm Password</i>
						<input type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Confirm Password';}" required="">
			...
			<div class="forg">
				<p class="forg-right">Already have an account? <a href="login.php">Login here</a>.</p>
				<div class="clearfix"></div>
			</div>
