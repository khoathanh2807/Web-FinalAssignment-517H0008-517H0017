									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<ul class="multi-column-dropdown">
												...
												<li><a href="pccomponent.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Power</a></li>
			...
			<div class=" con-w3l wthree-of">
				<div class="col-md-3 pro-1">
					<div class="col-m">
						...
						<div class="mid-1">
							<div class="women">
								<h6><a href="single.php">Intel Core i9 9900K</a> 3.6GHz - 5GHz | 8 Cores - 16 Threads</h6>
							</div>
							<div class="mid-2">
