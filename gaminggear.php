	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<a href="gaminggear.php"><img class="first-slide" src="images/ba1.jpg" alt="First slide" width="1100px" height="500px"></a>

			</div>
			<div class="item">
				<a href="pccomponent.php"><img class="second-slide " src="images/ba.jpg" alt="Second slide" width="1100px" height="500px"></a>
